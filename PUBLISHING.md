...
As of 2026-05-24, the `v0.4.2` evidence release is published: canonical Accord
npm packages at `0.4.2`, maintained reference npm packages at `0.3.2`, and
Python `ergo-agent-pay==0.3.2`.

The publication evidence is archived in
[`docs/release-evidence/2026-05-24-v0.4.2-publish.md`](./docs/release-evidence/2026-05-24-v0.4.2-publish.md).
