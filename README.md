...
## Public website and canonical docs
...
- Agent/LLM index: https://accordprotocol.ai/llms.txt
- Sitemap: https://accordprotocol.ai/sitemap.xml
- Strategic North Star: [`docs/STRATEGIC_NORTH_STAR.md`](./docs/STRATEGIC_NORTH_STAR.md)
- Rail maturity matrix: [`docs/RAIL_MATURITY_MATRIX.md`](./docs/RAIL_MATURITY_MATRIX.md)
...
| Recommended usage | Local demos, mock rail, conformance testing, Ergo testnet, Base Sepolia |
| P4 pilot evidence | 5/5 complete in [`docs/pilots/`](./docs/pilots/) |
| Public launch status | Deferred until [`docs/LAUNCH_READINESS.md`](./docs/LAUNCH_READINESS.md) gates pass |
...
| Developer golden path | [`docs/DEVELOPER_GOLDEN_PATH.md`](./docs/DEVELOPER_GOLDEN_PATH.md) |
...
The `@accord-protocol/*` npm packages are published at `0.4.2`; the maintained reference npm packages and Python reference package are published at `0.3.2`. For local development and examples, keep using this monorepo workspace so tests, fixtures, and demos stay together.
...
To inspect the current external evidence set:
...
The Base Sepolia contract rail result includes a deployed `AgentPayReserveV0`
contract, live testnet transaction links, audit-gate output, and L4 conformance
output in [`docs/pilots/results/2026-05-23-base-sepolia-contract-rail.md`](./docs/pilots/results/2026-05-23-base-sepolia-contract-rail.md).

For the recommended end-to-end review path, use
[`docs/DEVELOPER_GOLDEN_PATH.md`](./docs/DEVELOPER_GOLDEN_PATH.md).

To integrate a new paid API, MCP tool, verifier, or agent service, start with
[`docs/PROVIDER_ONBOARDING.md`](./docs/PROVIDER_ONBOARDING.md). To prepare the
public launch package, use
[`docs/LAUNCH_READINESS.md`](./docs/LAUNCH_READINESS.md); launch posts and
mcp.so distribution are intentionally deferred until those gates pass.
