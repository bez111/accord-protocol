...
2. **SDK/package version** — npm/PyPI semver, e.g. `0.4.2`. This changes when implementation packages change.
...
| Release candidate | `release/v0.4.2` | Review and CI stage |
| Public package release | `v0.4.2` tag | npm/PyPI publication if configured |
