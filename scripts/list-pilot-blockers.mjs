...
const completedPilotCount = new Set(completed.map((item) => item.pilot.toLowerCase())).size;
...
console.log(`P4 pilot status: ${completedPilotCount}/${matrix.size} complete, ${pending.length} pending.`);
