...
Run `npm run pilots:sage:live` to recheck the live Sage Ergo full receipt bundle;
it currently verifies the public full receipt bundle, hashes, schemas, semantic
bindings, signed conformance evidence, and Ergo testnet chain evidence.
...
| Ergo testnet Note settlement | Pass | [`results/2026-05-24-sage-ergo-testnet-full-receipt-recheck.md`](./results/2026-05-24-sage-ergo-testnet-full-receipt-recheck.md) |
...
| Base Sepolia contract rail | Pass | [`results/2026-05-23-base-sepolia-contract-rail.md`](./results/2026-05-23-base-sepolia-contract-rail.md) |
