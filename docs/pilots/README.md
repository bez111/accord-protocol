...
|---|---|
| Base Sepolia contract rail | Local stub runner exists (`npm run pilots:base:stub`) and live runner is prepared (`npm run pilots:base:live`), but pass still needs Base Sepolia contract address, live testnet transaction evidence, audit-gate result, and conformance output |
