...
| [`17-provider-onboarding-kit`](../examples/17-provider-onboarding-kit/) | Provider template | No | No | No | Copyable `.well-known/accord`, receipt, registry profile, badge, and PR templates for an Accord-compatible provider. |
