# v0.4.x release checklist and publication record

This page records the completed `v0.4.2` package publication and keeps the same
checklist useful for future `v0.4.x` patch releases.
...
| PyPI registry verification | `ergo-agent-pay==0.3.2` is available on PyPI | accord-protocol |
...
| `v0.4.2` package versions | Accord packages `0.4.2`; legacy/reference packages `0.3.2`; Python `0.3.2` | published |
...
Publication evidence: [`docs/release-evidence/2026-05-24-v0.4.2-publish.md`](./release-evidence/2026-05-24-v0.4.2-publish.md).
...
- Accord packages published at the release version;
- legacy/reference packages published at the matching reference release version;
- Python reference package published at the matching reference release version;
