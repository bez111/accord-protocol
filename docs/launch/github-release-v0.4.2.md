# Accord Protocol v0.4.2

Accord Protocol v0.4.2 is the evidence release for the open Accord standard and reference implementation.
...
- Canonical Accord packages: `@accord-protocol/*@0.4.2`
- Maintained legacy/reference packages: `ergo-agent-*@0.3.2` and `agentpay-base@0.3.2`
- Python reference package: `ergo-agent-pay==0.3.2`
...
- Base Sepolia contract rail live evidence with deployed `AgentPayReserveV0`, external transaction proof, audit-gate result, and conformance output.
- `agentpay-base` live-account write fix for local-wallet/viem flows.
- Mobile public-site improvements and refreshed status/roadmap/developer golden path docs.
