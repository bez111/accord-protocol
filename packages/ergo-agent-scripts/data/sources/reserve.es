{
    ...
    //
    // ──────────────────────────────────────────────────────────────────────
    // VENDORED FROM kushti/ChainCash with Accord v0 compatibility changes.
    // Mainnet use remains blocked until an external audit signs the exact
    // compiled tree in the public manifest.
    // ──────────────────────────────────────────────────────────────────────
    ...
    // R5 (tree of note tokens) is part of selfPreserved by default. Paths
    // that legitimately mutate R5 (none in v0) must override locally.
    val selfPreserved =
