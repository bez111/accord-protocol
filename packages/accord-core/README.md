...
Core SDK for [Accord Protocol](https://accordprotocol.ai/). Canonicalize, hash, and validate the three v0 protocol objects.

Public docs: [Learn](https://accordprotocol.ai/learn/) · [Status](https://accordprotocol.ai/status/) · [Repository](https://github.com/accord-protocol/accord-protocol)
