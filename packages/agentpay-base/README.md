...
const privateKey = readFileSync("/secure/local/base-sepolia-key.hex", "utf8").trim()
...
| Receiver binding | predicate-dependent; production use requires audited receiver binding | **built in via msg.sender == recipient** |
